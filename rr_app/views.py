...
def master(request):
    ...
    if all_tenant_db_data:
        for tenant_data in all_tenant_db_data:
            ...
            master_values.append([all_house_number['house_number'], all_room_number['room_number'], all_cts_number['cts_number'], tenant_data['tenant_name'], tenant_dod, tenant_data['tenant_gender'], str(tenant_data['tenant_mobile_number']), tenant_data['tenant_permanent_address'], '<a href=' + '"' + '/crud_operation/' + str(tenant_data['id']) + '">Edit</a>'])
