...
def master(request):
    if request.method == 'POST' and request.session['master_crud'] == 'Edit':
    ...
    if request.method == 'POST' and request.session['master_crud'] == 'Add':
        get_house_number = request.POST.get('house')
        get_cts_number = request.POST.get('cts')
        get_room_number = request.POST.get('room')
        get_tenant_name = request.POST.get('tenant_name')
...
def crud_operation(request):
    try:
        ...
        # messages.error(
        #     request, 'No Tenant ID Found. Please go back and try again.')
        # return redirect('/master/')
        # html = "<html><body>No Tenant ID Found. Please go back and try again.</body></html>"
...
def tenant_bill(request):
    ...
    if request.method == 'POST' and request.session['bill_crud'] == 'Edit':
    ...
    if request.method == 'POST' and request.session['bill_crud'] == 'Add':
        bill_house_number = request.POST.get('house')
        bill_room_number = request.POST.get('room')
        bill_cts_number = request.POST.get('cts')
        # bill_tenant_mobile_number = request.POST.get('tenant_mobile_number')
...
def tenant_bill_crud(request):
    try:
        ...
        print('Edit Data Fetch Failed!! -> Error: ', str(e))
        # html = "<html><body>Bill ID not Found. Please go back and try again.</body></html>"
        # return HttpResponse(html)    
